...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Perudo — Bluff. Bid. Survive." },
      ...
      { name: "author", content: "Perudo" },
      { property: "og:title", content: "Perudo — Bluff. Bid. Survive." },
      ...
      { name: "twitter:title", content: "Perudo — Bluff. Bid. Survive." },
